...
# https://github.com/MegviiDetection/video_analyst/blob/master/videoanalyst/model/utils/load_state.py
...
def load_pretrained_and_check(model, checkpoint_state_dict):
    ...
    if incompatible.missing_keys:
        missing_keys = filter_reused_missing_keys(model,
